...
namespace Data
{
    ...
    internal class DataTables
    {
        ...
        private static SqlDataAdapter adapterDisplayAssign = InitAdapterDisplayAssign();
        ...
        private static SqlDataAdapter InitAdapterDisplayAssign()
        {
            SqlDataAdapter r = new SqlDataAdapter(
                "SELECT e.EmpId, e.EmpName, p.ProjId, p.ProjName, a.Eval " +
                "FROM Assignments a, Employees e, Projects p " +
                "WHERE a.EmpId = e.EmpId AND a.ProjId = p.ProjId " +
                "ORDER BY EmpId, ProjId ",
                Connect.ConnectionString);
        ...
        private static void loadDisplayAssign(DataSet ds)
        {
            adapterDisplayAssign.Fill(ds, "DisplayAssignments");
            ...
            ForeignKeyConstraint myFK01 = new ForeignKeyConstraint("MyFK01",
                ...
                new DataColumn[] {
                    ds.Tables["DisplayAssignments"].Columns["EmpId"],
                }
            );
            myFK01.DeleteRule = Rule.Cascade;
            myFK01.UpdateRule = Rule.Cascade;
            ds.Tables["DisplayAssignments"].Constraints.Add(myFK01);
            ...
            ForeignKeyConstraint myFK02 = new ForeignKeyConstraint("MyFK02",
              ...
              new DataColumn[] {
                    ds.Tables["DisplayAssignments"].Columns["ProjId"],
              }
          );
            myFK02.DeleteRule = Rule.None;
            myFK02.UpdateRule = Rule.Cascade;
            ds.Tables["DisplayAssignments"].Constraints.Add(myFK02);
        ...
        internal static SqlDataAdapter getAdapterDisplayAssign()
        {
            return adapterDisplayAssign;
        }
    ...
    internal class Assignments
    {
        ...
        {
            displayAssign= ds.Tables["DisplayAssignments"];
