    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var resultQ1 = from c in dataSet.Tables["ChildTable"].AsEnumerable()
                           ...
                           on c.Field<int>("ParentID") equals p.Field<int>("ID")    // == is not valid here et "equals" n'est pas symmetrique
                           select new { ID=c.Field<int>("ChildID"),
                                        Name = c.Field<string>("ChildItem"),
                                        Parent= p.Field<string>("ParentItem")
                                      };
            ...
            var resultM1 = dataSet.Tables["ChildTable"].AsEnumerable()
                                       ...
                                       c => c.Field<int>("ParentID"), p => p.Field<int>("ID"),
                                       (c, p) => new { ID = c.Field<int>("ChildID"),
                                                       Name = c.Field<string>("ChildItem"),
                                                       Parent = p.Field<string>("ParentItem")
                                                     });
            ...
            var resultM2 = dataSet.Tables["ChildTable"].AsEnumerable()
                          ...
                          .Where(z => z.x.Field<int>("ParentID") == z.y.Field<int>("ID"))
                          .Select(z => new
                          {
                              ID = z.x.Field<int>("ChildID"),
                              Name = z.x.Field<string>("ChildItem"),
                              Parent = z.y.Field<string>("ParentItem")
                          });
